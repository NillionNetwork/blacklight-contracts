...
library BlacklightOutputLib {
    function writeContractAddresses(
        Vm vm,
        BlacklightTypes.DeployedContracts memory deployed,
        ...
        output =
            string.concat(output, "WEIGHTED_COMMITTEE_SELECTOR=", vm.toString(address(deployed.selector)), "\n");
        ...
        if (emissionsDeployed) {
            ...
            output =
                string.concat(output, "MOCK_L1_STANDARD_BRIDGE=", vm.toString(address(deployed.mockBridge)), "\n");
        }
